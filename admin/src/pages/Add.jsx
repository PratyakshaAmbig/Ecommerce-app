  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
        ...
        <div className='flex gap-2 mt-2 items-center'>
            <input onClick={()=>setBestSeller(!bestSeller)} checked={bestSeller} type='checkbox' id='bestseller'/>
            <label className='cursor-pointer' htmlFor='bestseller'>Add to bestseller</label>
        </div>
        
        <button type='submit' className={`${inActiveButton?'opacity-70 cursor-not-allowed bg-black text-white':'bg-black text-white'} w-28 py-3 mt-4  cursor-pointer`}>ADD</button>
    </form>
  )
}
